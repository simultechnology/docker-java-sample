...
public class GenericContainer<SELF extends GenericContainer<SELF>>
        ...
        implements org.testcontainers.containers.Container<SELF>, AutoCloseable, WaitStrategyTarget, Startable {
     ...
     */
    @Override
    public SELF withVolumesFrom(org.testcontainers.containers.Container container, BindMode mode) {
        addVolumesFrom(container, mode);
        return self();
    }

    private void addVolumesFrom(org.testcontainers.containers.Container container, BindMode mode) {
    ...
    protected void addFixedExposedPort(int hostPort, int containerPort) {
        addFixedExposedPort(hostPort, containerPort, org.testcontainers.containers.InternetProtocol.TCP);
    }
