...
public class TestcontainersConfiguration {
    ...
    private static final String VNC_RECORDER_IMAGE = "org/testcontainers/vnc-recorder";
    private static final String COMPOSE_IMAGE = "docker/compose";
    private static final String ALPINE_IMAGE = "alpine";
    private static final String RYUK_IMAGE = "org/testcontainers/ryuk";
    ...
    private static final String SSHD_IMAGE = "org/testcontainers/sshd";
